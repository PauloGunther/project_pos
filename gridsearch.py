...
def sarimax_gridsearch_rmse_diff2(y, y_train, y_test, exog_train=None, exog_test=None,
...
def sarimax_gridsearch_AIC_diff2(y, y_train, y_test, exog_train=None, exog_test=None,
                           p_values=range(1, 3), d_values=range(0, 2), q_values=range(1, 3),
                           P_values=range(1, 5), D_values=range(1, 5), Q_values=range(1, 5),
                           seasonal_period=12):
    """
